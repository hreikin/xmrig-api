...
log.info(miner_a.get_summary())
log.info(miner_a.get_backends())
log.info(miner_a.get_config())
log.info(miner_b.get_summary())
log.info(miner_b.get_backends())
log.info(miner_b.get_config())
