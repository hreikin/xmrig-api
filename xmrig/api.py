...
class XMRigAPI:
    ...
    def _update_properties(self, data: Dict[str, Any]) -> None:
        """
    ...
    def get_summary(self) -> bool:
        ...
        try:
            ...
            self._update_properties(self._summary_response)
    ...
    def get_backends(self) -> bool:
        ...
        try:
            ...
            self._update_properties(self._backends_response)
    ...
    def get_config(self) -> bool:
        ...
        try:
            ...
            self._update_properties(self._config_response)
    ...
    def post_config(self, config: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            self._update_properties(self._post_config_response)
